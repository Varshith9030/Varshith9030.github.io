...
(function () {
  ...
  const COMMANDS = {
    ...
    whoami: () => [
      ...
      { html: 'Currently a <span class="t-out-accent">Red Team Security Analyst Intern at FireCompass</span>,', cls: 't-out' },
    ...
    experience: () => [
      ...
      { html: '<span class="t-out-dim">Jun 2025 &mdash; Present &middot; Remote</span>', cls: 't-out' },
      { html: '', cls: 't-out' },
      { html: '  &gt; Execute end-to-end adversary simulations &mdash; reconnaissance,', cls: 't-out' },
